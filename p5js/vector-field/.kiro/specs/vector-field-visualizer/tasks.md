...
- [x] 2.10 Write property test for grid spacing sequence
  - **Property 9: Grid spacing follows allowed sequence**
  - **Validates: Requirements 5.1**

- [x] 2.11 Write property test for grid density bounds
  - **Property 10: Grid density stays bounded**
  - **Validates: Requirements 3.2, 5.2**

- [x] 2.12 Write property test for grid spacing progression
  - **Property 11: Grid spacing progression**
  - **Validates: Requirements 3.2**

- [x] 2.13 Implement visible bounds calculation
  - Write getVisibleBounds() method returning {minX, maxX, minY, maxY}
  - _Requirements: 2.1, 5.3, 5.4_

- [x] 3. Implement expression evaluator module
- [x] 3.1 Create ExpressionEvaluator class wrapping math.js
...
- [x] 3.2 Implement expression evaluation
...
- [x] 3.3 Write property test for valid expression evaluation
  - **Property 1: Valid expression evaluation produces numeric results**
  - **Validates: Requirements 1.2**

- [x] 3.4 Implement expression validation
...
- [x] 6.14 Write property test for brush thickness
  - **Property 21: Brush respects thickness**
  - **Validates: Requirements 9.2**

- [x] 6.15 Write property test for brush density
  - **Property 22: Brush respects density**
  - **Validates: Requirements 9.3**

- [x] 6.16 Implement clear particles method
  - Write clear() method to remove all particles
  - _Requirements: 6.1_

- [x] 7. Implement input handler module
- [x] 7.1 Create InputHandler class
...
- [x] 8.3 Initialize MathLive math fields
...
- [x] 8.4 Implement expression update handler
...
- [x] 11.4 Add example vector fields
